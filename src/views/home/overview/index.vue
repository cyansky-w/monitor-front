<template>
  <div class="container-fluid">
    <div class="row-title">
      ...
      <div class="block">
        <BaseTimePicker @change="initData"/>
  ...
  <div class="row">
    <div class="col-md-4 mb-3">
      <div class="card">
        ...
        <div class="card-body">
          <MCharts :option="optionPv" style="width: 100%; height: 400px" />
        </div>
      </div>
    </div>
    <div class="col-md-4 mb-3">
      <div class="card">
        ...
        <div class="card-body">
          <MCharts :option="optionActive" style="width: 100%; height: 400px" />
        </div>
      </div>
    </div>
    ...
    <div class="col-md-4 mb-3">
      <div class="card">
        ...
        <div class="card-body">
          <MCharts :option="optionNewActive" style="width: 100%; height: 400px" />
        </div>
      </div>
    </div>
  </div>
  ...
  <div class="row">
    <div class="col-md-4 mb-3">
      <div class="card h-150">
        ...
        <div class="card-body">
          <MCharts :option="optionJump" style="width: 100%; height: 400px" />
        </div>
      </div>
    </div>
...
let optionPv = reactive(JSON.parse(JSON.stringify(optionTrend)));
let optionActive = reactive(JSON.parse(JSON.stringify(optionTrend)));
let optionNewActive = reactive(JSON.parse(JSON.stringify(optionTrend)));
let optionJump = reactive(JSON.parse(JSON.stringify(optionTrend)));
...
async function initData(){
  getOptionUserNum();
  await getOptionTrend(optionPv);
  await getOptionTrend(optionActive);
  await getOptionTrend(optionNewActive);
  await getOptionTrend(optionJump);
...
let timestamp = ref(projectStore.getTimestamp);
