<template>
    <div class="container-fluid">
        <div class="row-title">
      <div class="fw-bold fs-4">用户访问地域分布</div>
      <div class="block">
        ...
        <div class="row">
            ...
            <div class="map-list">
                <div class="card text-black bg-light">
                    <div class="card-header"> 访问用户Top榜</div>
                    <div class="card-body">
                        <table class="table table-borderless">
                            ...
                            <tbody>
                                <div v-for="(item ,index) in topList.list" :key="index"  class="row text-center">
...
let topList = reactive({list:[]})
onMounted(async() => {
    await setData();
})

async function setData(){
    topList.list = await initData(chinaOption);
}
