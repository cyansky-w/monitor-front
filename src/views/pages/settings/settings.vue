<template>
    <div class=" bg-light pt-3">
        <div class="container-xl rounded-1 bg-white"> 
            ...
            <div class="mb-3 row">
                ...
                <div class="col-sm-10 d-flex align-items-center">
                    <div class="form-check me-3" v-for="(item,index) in productionList" :key="item.value">
                        <input class="form-check-input" type="checkbox" :checked="item.checked" :id="`production_${item.value}`">
        ...
        <div class="setting-content form">
            <div class="fs-6 pb-3 fw-bold">应用配置</div>
              ...
              <div class="col-sm-10">
                ...
                <label class="form-check-label" :for="`config_${item.value}`" @click="checkConfig(index)">{{item.describe}}</label>
                </div>
              </div>
            </div>
        </div>
