        ...
        <div class="container-fluid">
            ...
            <div class="collapse navbar-collapse " id="navbarText">
                ...
                <ul class="navbar-nav">
                    ...
                    <li class="nav-item" v-if="projectStore.getProjectId">
                    ...
                    <li class="nav-item dropdown" v-if="projectStore.getProjectId">
                    ...
                    <li class="nav-item dropdown" v-if="projectStore.getProjectId">
                        <a class="nav-link dropdown-toggle" data-bs-toggle="dropdown" href="#" role="button" aria-expanded="false">性能</a>
                            ...
                            <li><router-link class="dropdown-item" :to="{name: 'paintPerformance'}">渲染性能分析</router-link></li>
                            </ul>
                    </li>
                    <li class="nav-item">
                        <router-link class="nav-link btn-admin" :to="{name: 'managerSetting'}" v-if="userStore.getLoginStatus">管</router-link>
                        <router-link class="nav-link" :to="{name: 'login'}" v-else>登录</router-link>
                    </li>
                </ul>
            </div>
        </div>
